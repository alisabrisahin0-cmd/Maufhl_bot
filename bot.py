    ...
    try:
        ...
        await bot.send_message(
            ...
            text=(
                ...
                "📡 *Gemini Ek Bildirim Sistemi:*\n"
                "✅ G1: Ultra Erken Yıkım (%90.7, n=129)\n"
                "✅ G2: Erken Favori Baskısı (%90.7, n=237)\n"
                "✅ G3: Yaralı Favori Geri Dönüş (%91.0, n=100)\n"
                "✅ G4: Ağır Favori+Beraberlik (%88.7, n=142)\n"
                "✅ G5: Dep Korner Baskısı (%81.5, n=604)\n"
                "✅ G6: Erken Dep Önde (%88.1, n=427)\n"
                "✅ G7: Erken Ev Önde (%87.3, n=653)\n"
                "✅ G8: Ağır Favori Genel (%88.3, n=617)\n"
                "✅ G9: Ağır Sürpriz (%87.6, n=291)"
            ),
            parse_mode="Markdown"
        )
    except Exception as e:
