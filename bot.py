...
def nesine_lig_kontrolu(ev_adi, dep_adi):
    ...
    # Elenmesi gereken kelimeler
    elenecek_kelimeler = [
        'reserves', 'reserve', 'u19', 'u20', 'u21', 'u23',
        'esports', 'e-sports', 'esport', 'e-sport',
        '(w)', 'women', 'kadın', 'kadin',
        'youth', 'junior', 'academy',
        'virtual', 'simulation', 'sim',
    ...
    for kelime in elenecek_kelimeler:
        if kelime in mac_metni:
            logger.info(f"🚫 Nesine'de yok: '{kelime}' tespit edildi")
            return False
