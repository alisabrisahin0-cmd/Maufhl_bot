...
async def ana_dongu():
    try:
        ...
        await bot.send_message(
            chat_id=CHAT_ID,
            text=(
                "🚀 **BOT V44 LİTERATÜR PRO - FIX V4**\n\n"
                "📚 **LİTERATÜR BAZLI:** Akademik rapor uyumlu\n\n"
                "🔧 **FIX V4 YENİLİKLERİ:**\n"
                "• ✅ Asian Handicap Parse FIX (Liste formatı)\n"
                "• ✅ Grok AI Entegrasyonu (Gemini fallback)\n"
                "• ✅ Doğrulama Bayrakları Görünür\n"
                "• ✅ API Response Yapısı Güncellendi\n\n"
                "🎯 **YENİ ÖZELLİKLER:**\n"
                ...
                "• USA (Uzun Süreli Anomali): 75+ dk kontrolü\n"
                "• MA (Master Algoritma): Ekstrem koşul\n\n"
                "🤖 **AI ANALİZ:**\n"
                "• Öncelik: Grok AI (xAI)\n"
                "• Fallback: Gemini AI (3 key rotasyon)\n\n"
                "🎯 **MEVCUT ÖZELLİKLER:**\n"
