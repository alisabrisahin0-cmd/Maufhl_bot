...
async def ana_dongu():
    try:
        ...
        await bot.send_message(
            chat_id=CHAT_ID,
            text=(
                "🚀 **BOT V44 LİTERATÜR PRO - HYBRID MODE**\n\n"
                "✅ **GÜNCELLEME:** Event detay endpoint aktif!\n"
                "   📡 Öncelik: Event detay API\n"
                "   🔄 Fallback: Inplay verisi\n\n"
                "🎯 **Özellikler:**\n"
                ...
                "• 🆕 Event Detay Endpoint (Öncelikli veri kaynağı)\n\n"
                "📊 **Hedef Başarı:** %85-90\n"
                "🎯 **Minimum Eşik:** 9.0\n"
                "🤖 **AI:** Temperature 0.9 (Yaratıcı)\n"
                "🛡️ **Veri Koruma:** Aktif\n"
                "📡 **Veri Kaynağı:** Event detail (primary) + Inplay (fallback)\n\n"
                "✅ **Veri Akışı:**\n"
                "1. Event detay API çağrısı (öncelikli)\n"
                "2. Başarısız olursa inplay verisi kullanılır\n"
                "3. Bot kesintisiz çalışmaya devam eder"
            )
        )
